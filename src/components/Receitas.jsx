...
function Receitas() {
    ...
    function adicionartextos() {
        ...
        // Limpa os campos de entrada após adicionar a receita
        setNomeReceita('');
        setIngredientes('');
        setModoPreparo('');
        setAdicionais('');
    ...
    return (
        <div>
            <div>
                ...
                <label>
                    Ingredientes:
                    <input onChange={pegarIngre}/>
                </label>

                <label>
                    Modo de preparo:
                    <input onChange={pegarModo}/>
                </label>

                <label>
                    Adicionais(se tiver):
                    <input onChange={pegarAdi}/>
                </label>

                <button onClick={adicionartextos}>Adicionar</button>
